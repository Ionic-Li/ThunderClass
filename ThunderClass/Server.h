...
【接口说明】
	...
	函数SendToExcept(unsigned int idx, const Message& aMessage)不给idx用户发消息
...
public:
	...
	//不给idx用户发消息
	void SendToExcept(unsigned int idx, const Message& aMessage);
