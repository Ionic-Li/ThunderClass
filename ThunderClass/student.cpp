...
Student::Student(const string& Name, const string& Password)
	: User(Name, Password, "Student"), TheTimeCount(m_CTimeCount)
{
    //教师端使用，默认没有连接到教师端
...
【更改记录】       无
*************************************************************************/
void Student::SaveTimeCount(const TimeCount& CTimeCount)
{
	m_CTimeCount = m_CTimeCount + CTimeCount;
}

/*************************************************************************
【函数名称】       ClearTimeCount
【函数功能】       用于清空上课时长数据，用于教师端
【参数】           无
【返回值】         无
【开发者及日期】   李永健 2020/6/17
【更改记录】       无
*************************************************************************/
void Student::ClearTimeCount()
{
	m_CTimeCount = TimeCount();
}